    ...
    <section id="origins" class="mb-5">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center">
                <i class="fa-duotone fa-graduation-cap display-1 text-secondary opacity-25"></i>
            </div>
        </div>
    </section>
    ...
    <section id="homecoming" class="mb-5">
        ...
        <div class="alert alert-dark border-warning mt-4">
            <div class="d-flex align-items-center">
                <i class="fa-duotone fa-shield-halved fs-2 text-warning me-3"></i>
                <div>
                    <h4 class="alert-heading text-warning">The 2018 Refusal</h4>
                    <p class="mb-0">
                        In 2018, a major multinational record conglomerate made a nine-figure offer to acquire <strong>Engine Room Records, LLC</strong> and the band's entire back catalog.
                    </p>
                    <hr>
                    <p class="mb-0 fst-italic">
                        The five members—Ryan, Cassidy, Holly, Evan, and Tyler—voted unanimously within 24 hours. <strong>The answer was "No."</strong> They stated simply: "We didn't build a fortress just to sell the keys."
                    </p>
                </div>
            </div>
        </div>
