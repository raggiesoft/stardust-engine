...
<div class="container py-5">
    <div class="row g-5">
        ...
        <div class="col-lg-8">
            ...
            <p class="text-muted">
                While still a student, she took over as the band's manager. Her official role was to act as the emotional peacemaker—famously pulling Ryan and Cassidy into a "three-way hug" when they argued over music, reminding them "You're both right. And you're both idiots" [cite: 36, 1319-1320].
            </p>
