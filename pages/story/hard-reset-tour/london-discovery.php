...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-9">
            ...
            <div class="card glass-card border-info p-4 mb-5">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
            <h3 class="h5 text-uppercase text-secondary fw-bold mb-3">The Deal</h3>
            <div class="card bg-white shadow-lg transform-rotate-1 p-4" style="font-family: 'Caveat', cursive;">
